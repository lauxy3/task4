...
function submitInfo(){
    ...
    myObj.hide();
    var data = {};
    data.name = myTasks.name;
    data.subject = myTasks.subject;
    data.date = myTasks.date;
    data.describe = myTasks.describe;
    var task_post_url = 'http://localhost/task'
    
    axios.post(task_post_url, data)
    .then(response => {
